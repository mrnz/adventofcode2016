...
describe('Day 12', function() {
  ...
  describe('Part One', function() {
    ...
    it('should return array length 2 when input is "aaa\\naaa"', function () {
        assert.equal( 2, day12.prepareDate('aaa\naaa').length );
    });
